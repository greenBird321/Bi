...
var jp_config = {
  ...
  plot:           [   '../assets/libs/jquery/flot/jquery.flot.js',
                      ...
                      '../assets/libs/jquery/flot/jquery.flot.time.js',
  ...
  dataTable:      [   '/assets/libs/jquery/datatables/media/js/jquery.dataTables.min.js',
                      '/assets/libs/jquery/datatables/media/js/dataTables.fixedColumns.min.js',
  ...
  duallistbox:    [   '../assets/libs/jquery/duallistbox/jquery.bootstrap-duallistbox.js',
                      '../assets/libs/jquery/duallistbox/bootstrap-duallistbox.css'],
  amcharts:       [   '/assets/libs/jquery/amcharts/export/export.css',
                      '/assets/libs/jquery/amcharts/amcharts.min.js',
                      '/assets/libs/jquery/amcharts/pie.js',
                      '/assets/libs/jquery/amcharts/serial.js',
                      '/assets/libs/jquery/amcharts/themes/light.js',
                      '/assets/libs/jquery/amcharts/lang/zh.js']
};